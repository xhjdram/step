...
$(document).ready(function(){
    alert("<s:property value='#session.user'/>");
...
<BODY>
	<FORM id=form1 name=form1
		...
		<input type="hidden" name="user.u_id" value="<s:property value='#session.user.u_id'/>" />
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<input type="button" value="选择客户"
									   onclick="window.open('${pageContext.request.contextPath}/customerAction_list?we=lol','','width=620,height=246')"/>
